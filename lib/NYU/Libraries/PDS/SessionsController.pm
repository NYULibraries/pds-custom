...
# Default constants
use constant UNAUTHORIZED_URL => "https://beta.library.nyu.edu/errors/pds-library-nyu-edu/unauthorized";
use constant EZPROXY_UNAUTHORIZED_URL => "https://beta.library.nyu.edu/errors/ezproxy-library-nyu-edu/unauthorized";
use constant EZBORROW_UNAUTHORIZED_URL => "https://beta.library.nyu.edu/errors/ezborrow-library-nyu-edu/unauthorized";
