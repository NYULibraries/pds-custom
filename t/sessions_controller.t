...
# is($controller->login(), NYU_LOGIN, "Unexpected login html");
# 
...
# # Test authenticate
# is($controller->authenticate("DS03D", "TEST"), "<?xml version=\"1.0\" encoding=\"UTF-8\"?>".
#   "<session>".
#     "<id>DS03D</id>".
...
# $controller = NYU::Libraries::PDS::SessionsController->new($conf, "NYU", "primo", "http://example.com");
# # Test authenticate
# is($controller->authenticate("DS03D", "FAIL"), NYU_LOGIN, "Authenticate should be login screen");
# # Test error undefined after authenticate
